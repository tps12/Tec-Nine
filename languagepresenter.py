...
class LanguagePresenter(object):
    ...
    def borrow(self):
        ...
        adapted = next(languagesimulation.adaptsounds(borrowed, words.vowels, words.consonants, words.stress))
        constrained = next(languagesimulation.constrain(adapted, words.constraints, words.vowels, words.stress))
